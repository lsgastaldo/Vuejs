                    ...
                    >   
                        ...
                        >
                            <v-toolbar 
                                ...
                                flat
                            >
                                <v-toolbar-title>Alterar Projeto</v-toolbar-title>
                                <v-spacer></v-spacer>
                                <v-icon dark right>mdi-folder-edit</v-icon>
                            </v-toolbar>
                            ...
                            <v-card-text>
                                ...
                                >   
                                    <v-text-field
                                        ...
                                        v-model="information.nomeProjeto"
                                    ...
                                    <v-text-field
                                        ...
                                        v-model="information.dataInicio"
...
export default {
    ...
    methods: {
        makeForm(){
            axios
                ...
                .then(res=>{
                    ...
                    this.numberColaborators = res.data.equipe.length
                    this.users = res.data.equipe
                    this.colaboratorsName = res.data.equipe
                    console.log(res)
                })
                .catch(e=>{
                    console.log(e)
        ...
        submit(){
            if(this.validate()){
                this.information.equipe = this.colaboratorsName
                this.information.token = this.$session.get("token")  
                axios
                .post(this.$baseURL + "/alterarProjeto", this.information)
                .then(res => {
